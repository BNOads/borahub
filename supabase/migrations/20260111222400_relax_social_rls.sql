...
DROP POLICY IF EXISTS "Enable all for everyone" ON public.social_profiles;
...
DROP POLICY IF EXISTS "Enable all for everyone editorial" ON public.editorial_lines;
...
DROP POLICY IF EXISTS "Enable all for everyone posts" ON public.social_posts;
...
DROP POLICY IF EXISTS "Enable all for everyone comments" ON public.post_comments;
...
DROP POLICY IF EXISTS "Enable all for everyone history" ON public.post_history;
