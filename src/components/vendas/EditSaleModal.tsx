...
import { useUpdateSale, useProducts, Sale } from "@/hooks/useSales";
...
const formSchema = z.object({
  ...
  proof_link: z.string().url("URL inválida").optional().or(z.literal("")),
  ...
  useEffect(() => {
    if (sale && open) {
      form.reset({
        ...
        product_id: sale.product_id || "__none__",
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" min="1" max="24" {...field} disabled />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
